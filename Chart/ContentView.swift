...
struct PractiseView: View {
    ...
    let name = ["Biology","English","Computer Enginnering Technology", "Introduction to Computer Science", "World History since the Fifteenth Century", "Functions", "Introduction to Fiancial Accounting"]
